...
void oplus_init_sensor_state(struct SensorState *mSensorState)
{
    ...
    //pengqingqing@ANDROID.AITECH,2020/07/01, add for activity_recognition
    ...
    #ifdef CONFIG_OPLUS_FEATURE_ACTIVITY_RECOGNITION
    //pengqingqing@ANDROID.AITECH,2020/09/07, add for activity_recognition
...
static int handle_to_index(int handle)
{
    ...
    switch (handle) {
    /*xiebaixue@PSW.BSP.Sensor, 2020/04/16, Add for oplus algo*/
